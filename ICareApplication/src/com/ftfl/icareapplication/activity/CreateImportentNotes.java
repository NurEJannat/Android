...
public class CreateImportentNotes extends Activity implements OnClickListener,
OnDateSetListener {
...
case R.id.btnImporrtentNoteSave:
	...
	if (mNotesID != null) {
		...
		if (mNotesDS.insert(profileInsert) == true) {
			...
			startActivity(new Intent(CreateImportentNotes.this,
