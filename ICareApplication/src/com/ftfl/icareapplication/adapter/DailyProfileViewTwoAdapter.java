...
public class DailyProfileViewTwoAdapter extends ArrayAdapter<ICareActivityDietChart>{
...
TextView tvEvent, tvTime, tvManu;
	...
	public DailyProfileViewTwoAdapter(Activity context, List<ICareActivityDietChart> allDailyDietChart) {
