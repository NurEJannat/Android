package com.ftfl.meetingplace.adapter;
...
public class Customadapter extends ArrayAdapter<MeetingPlaceInformation> {

	private static LayoutInflater mInflater = null;

	List<MeetingPlaceInformation> mPlaces;
	...
	public Customadapter(Activity context, List<MeetingPlaceInformation> ePlaces) {
		super(context, R.layout.activity_place_list, ePlaces);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			vi = mInflater.inflate(R.layout.activity_place_list, null);
		...
		MeetingPlaceInformation places;
