...
public class PersonProfileInsertActivity extends Activity {
	...
	String mDescription = "";
	byte[] mImage = null;
	PersonProfile mPlace = null;
	String mID = "";
	PersonDataSource mDataSource = null;
	LocationManager lm;
	String provider;
	Location location;
	...
	// create class object
	gps = new GPSTracker(PersonProfileInsertActivity.this);
	...
	mPlace = new PersonProfile(mDate, mTime, mLatitude, mLongitude,
	mDescription, mImage);
	mDataSource = new PersonDataSource(this);
	
	
	if (mDataSource.insert(mPlace) == true) {
